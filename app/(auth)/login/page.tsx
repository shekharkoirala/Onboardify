...
import { Truck, Mail, Lock, Github, AlertCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-dark-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="flex items-center justify-center mb-8">
          <Truck className="h-10 w-10 text-dark-700" />
          <h1 className="text-3xl font-bold text-dark-800 ml-2">Onboardify</h1>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-3 h-4 w-4 text-dark-500" />
                  <Input
                    id="email"
                    type="email"
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-sm text-dark-600 hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-dark-500" />
                  <Input
                    id="password"
                    type="password"
                    placeholder="••••••••"
